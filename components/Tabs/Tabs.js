...
class TabLink {
  constructor(element) {
    ...
    // this.data = document.querySelectorAll('.tab-item');
    
    // Using the custom data attribute get the associated Item element
    this.itemElement = document.querySelector(`[data-tab='${element.dataset.tab}']`);
...
class TabItem {
  ...
  select() {
    ...
    const items = document.querySelectorAll('.tabs-elements');
